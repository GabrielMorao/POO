 ...
 */
public class TabuleiroController implements  MouseListener, MouseMotionListener, Serializable{

  private  transient Tabuleiro view;
  private  transient Save salvar;
  private  transient ModelTabuleiro model;
  private  transient Peca p;
  private  transient Peca peca_clicada;
  private  transient boolean flag;                                     //checa se o jogador e o certo
  private  int jogador;
  private  boolean mat[][] = new boolean[8][8];
    ...
    public void addModel (ModelTabuleiro model, int jogador){
        this.model = model;
        p = null;
        peca_clicada = null;
    ...
    public void addSave (Save salvar){
        this.salvar = salvar;
    }
    ...
    public void loadMat(boolean new_mat[][]){
        this.mat = new_mat;
    }
            ...
            if(p != null && peca_clicada == null && flag == true){//cliquei numa peca e nao tinha nada salvo
                if(p.getCor() == Peca.Cor.BRANCO && jogador != 1){
                    ...
                    try{
                        ...
                        mat[y/60][x/60] = true;
                       salvar.salva_jogo(model, mat, jogador); // Salvo o estado atual do jogo
                    }
                    }catch(MovimentoInvalidoException er){
                        System.out.println(er.toString() + " do " + peca_clicada);
                    }
                    peca_clicada = null;
            }
                    ...
                    try{
                       if(peca_clicada.move_to(x/60, y/60, mat)==true){
                        ...
                        System.out.println(er.getMessage() + " do " + peca_clicada);
                    }
                  peca_clicada = null;
            }
        }
